...
const FormLogin = ({ type, className }) => {
  const {
    register,
    handleSubmit,
        ...
        {!isLoading && (
          <>
            ...
            {form === "regist" && (
              <>
                <form
                  className="formLogin__form formLogin__form--register"
                ...
                >
                  ...
                  <p className="pLink">
                    ...
                    <p onClick={() => setform("login")}>
                      <span>Click aqui para entrar</span>
                    </p>
                  </p>
                </form>
              </>
